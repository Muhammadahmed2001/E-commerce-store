...
import profilePic from "../../assets/IMG_2526.jpg"
                    ...
                    <div className="flow-root">
                      <Link to={'/'} className="-m-2 block p-2 font-medium text-gray-900 cursor-pointer">
                        <img
                          ...
                          src="https://upload.wikimedia.org/wikipedia/commons/thumb/3/32/Flag_of_Pakistan.svg/640px-Flag_of_Pakistan.svg.png"
                          alt="pakistan-flag" />                                        </Link>
                    </div>
                  </div>
              ...
              <div className="flex h-16 items-center">
                ...
                <div className="ml-4 flex lg:ml-0">
                  <Link to={'/'} className='flex'>
                    <div className="flex ">
                      <h1 className=' text-2xl font-bold text-black  px-2 py-1 rounded' style={{ color: mode === 'dark' ? 'white' : '', }}>Pretty Posh</h1>
                    </div>
                  </Link>
                </div>
                ...
                <div className="ml-auto flex items-center">
                  ...
                  <div className="hidden lg:ml-8 lg:flex">
                    <a href="#" className="flex items-center text-gray-700 ">
                      <img
                        src="https://media.istockphoto.com/id/178885456/photo/flag-of-pakistan.webp?b=1&s=170667a&w=0&k=20&c=9EjLu7BFC8m9bviE7tbsEPWUYsKJNTQaWWjDvvBF8ms="
                        alt=""
                        className="block h-auto w-5 flex-shrink-0"
                      />
